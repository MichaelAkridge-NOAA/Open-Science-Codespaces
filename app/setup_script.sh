...
mkdir -p /workspaces/Open-Science-Codespaces/app/db-vol
chmod -R 777 /workspaces/Open-Science-Codespaces/app/db-vol
chmod -R 777 /workspaces/Open-Science-Codespaces/app/ords_config
