...
if ! grep -Fqx "$message" /workspaces/Open-Science-Codespaces/.devcontainer/rstudio-example-03/README.md; then
    echo "Debug: Message not found in README.md, appending now."
    echo "$message" >> /workspaces/Open-Science-Codespaces/.devcontainer/rstudio-example-03/README.md
else
